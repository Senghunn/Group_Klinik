...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="{{asset ('admin_assets2')}}/assets/img/apple-icon.png">
  <link rel="icon" type="image/png" href="{{asset ('admin_assets2')}}/assets/img/favicon.png">
  <title>
    Klinik | Register
  </title>
  <!--     Fonts and icons     -->
  ...
  <!-- Nucleo Icons -->
  <link href="{{asset ('admin_assets2')}}/assets/css/nucleo-icons.css" rel="stylesheet" />
  <link href="{{asset ('admin_assets2')}}/assets/css/nucleo-svg.css" rel="stylesheet" />
  <!-- Font Awesome Icons -->
  <script src="https://kit.fontawesome.com/42d5adcbca.js" crossorigin="anonymous"></script>
  <link href="{{asset ('admin_assets2')}}/assets/css/nucleo-svg.css" rel="stylesheet" />
  <!-- CSS Files -->
  <link id="pagestyle" href="{{asset ('admin_assets2')}}/assets/css/argon-dashboard.css?v=2.0.4" rel="stylesheet" />
</head>
...
<body class="">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="navbar-nav mx-auto">
          <li class="nav-item">
            <a class="nav-link d-flex align-items-center me-2 active" aria-current="page" href="{{asset ('admin_assets2')}}/pages/dashboard.html">
              <i class="fa fa-chart-pie opacity-6  me-1"></i>
              Dashboard
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link me-2" href="{{asset ('admin_assets2')}}/pages/profile.html">
              <i class="fa fa-user opacity-6  me-1"></i>
              Profile
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link me-2" href="{{asset ('admin_assets2')}}/pages/sign-up.html">
              <i class="fas fa-user-circle opacity-6  me-1"></i>
              Sign Up
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link me-2" href="{{asset ('admin_assets2')}}/pages/sign-in.html">
          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
                    ...
                    <form role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                        <input type="text" class="form-control" placeholder="Name" aria-label="Name" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                        </div>
                        <div class="mb-3">
                        <input type="email" class="form-control" placeholder="Email" aria-label="Email" name="email" value="{{ old('email') }}" required autocomplete="email">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                        <input type="password" class="form-control" placeholder="Retype Password" aria-label="Retype-Password" name="password_confirmation" required autocomplete="new-password">
                        </div>
  ...
  <!--   Core JS Files   -->
  <script src="{{asset ('admin_assets2')}}/assets/js/core/popper.min.js"></script>
  <script src="{{asset ('admin_assets2')}}/assets/js/core/bootstrap.min.js"></script>
  <script src="{{asset ('admin_assets2')}}/assets/js/plugins/perfect-scrollbar.min.js"></script>
  <script src="{{asset ('admin_assets2')}}/assets/js/plugins/smooth-scrollbar.min.js"></script>
  <script>
  ...
  <script src="{{asset ('admin_assets2')}}/assets/js/argon-dashboard.min.js?v=2.0.4"></script>
</body>
